package com.youkemm.kcommon.facade

import android.app.Application
import android.content.Context
import androidx.lifecycle.ProcessLifecycleOwner
import com.youkemm.kcommon.entity.net.IApiException
import com.youkemm.kcommon.listener.OnPageCreateListener
import com.youkemm.kcommon.listener.OnPageDestroyListener
import com.youkemm.kcommon.listener.OnPagePauseListener
import com.youkemm.kcommon.listener.OnPageResumeListener
import com.blankj.utilcode.util.Utils
import com.youkemm.kcommon.ktx.core.lifecycle.KtxAppLifeObserver
import com.youkemm.kcommon.ktx.core.lifecycle.KtxLifeCycleCallBack
...
class CommonLibrary private constructor() {
    ...
    fun initLibrary(
        ...
        if (watchActivityLife) context.registerActivityLifecycleCallbacks(KtxLifeCycleCallBack())
